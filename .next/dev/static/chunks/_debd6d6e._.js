...
"[project]/app/report/content/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function ContentCreationPage() {
    ...
    const { selectedItems, customItems, contentBySection, updateContent, markSectionComplete, getCompletionStatus } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useReportStore"])();
    const allItems = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "ContentCreationPage.useMemo[allItems]": ()=>[
                ...selectedItems,
                ...customItems
            ]
    }["ContentCreationPage.useMemo[allItems]"], [
    ...
    const handleGenerateAI = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ContentCreationPage.useCallback[handleGenerateAI]": async ()=>{
            if (!aiPrompt.trim()) {
                toast({
                    title: "Error",
            ...
            try {
                const generatedText = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["generateContent"])({
                    prompt: aiPrompt
                });
    ...
    }["ContentCreationPage.useCallback[handleGenerateAI]"], [
        aiPrompt,
        toast
    ]);
    const handleFileUpload = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ContentCreationPage.useCallback[handleFileUpload]": async (e)=>{
            const file = e.currentTarget.files?.[0];
            if (!file) return;
            setIsUploading(true);
            try {
                const extractedText = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["extractFromFile"])({
                    file
                });
    ...
    }["ContentCreationPage.useCallback[handleFileUpload]"], [
        toast
    ]);
    const handleSaveContent = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ContentCreationPage.useCallback[handleSaveContent]": ()=>{
    ...
    const handleMarkComplete = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ContentCreationPage.useCallback[handleMarkComplete]": ()=>{
            if (!editorContent.trim()) {
                toast({
                    title: "Error",
    ...
    const handleNext = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ContentCreationPage.useCallback[handleNext]": ()=>{
    ...
    const handlePrevious = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ContentCreationPage.useCallback[handlePrevious]": ()=>{
            if (currentIndex > 0) {
                handleSaveContent();
                setCurrentIndex(currentIndex - 1);
    ...
    const handleContinueToReview = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "ContentCreationPage.useCallback[handleContinueToReview]": ()=>{
            handleSaveContent();
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                            className: "space-y-2",
                                            children: allItems.map((item, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                    onClick: ()=>{
                                                        if (idx !== currentIndex) {
                                                            handleSaveContent();
                                                            setCurrentIndex(idx);
...
_s(ContentCreationPage, "BAPRH8gqHIcbN27Etreds0md3hg=", false, function() {
    return [
...
_c = ContentCreationPage;
var _c;
__turbopack_context__.k.register(_c, "ContentCreationPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_debd6d6e._.js.map